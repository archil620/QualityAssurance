...
public class Question1 {
	  ...
	  // Separated Paragraph and string tag as they were repeating
    ...
    public String BuildBookQuoteHTML() {
        ...
        builder.append(
            BuildBookQuoteP("I know not all that may be coming, but be it what it will, I’ll go to it laughing."));
        builder.append(BuildBookQuoteP("Maybe ever’body in the whole damn world is scared of each other."));
        builder.append(
            BuildBookQuoteP(
                "Life is to be lived, not controlled; and humanity is won by continuing to play in face of certain defeat."));
        builder.append(
            BuildBookQuoteP("It's the possibility of having a dream come true that makes life interesting."));
        builder.append(
            BuildBookQuoteP(
        ...
        builder.append(
            BuildBookQuoteP("And so we beat on, boats against the current, borne back ceaselessly into the past."));
        builder.append(
            BuildBookQuoteP(
